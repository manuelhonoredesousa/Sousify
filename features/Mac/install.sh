...
echo "======================================="
echo "      Sousify - MacOS - https://github.com/manuelhonoredesousa/Sousify"
echo "======================================="
echo "Sistema: $(sw_vers -productName) $(sw_vers -productVersion)"
echo

echo "1 - Instalacao Offline"
echo "2 - Instalacao Online"
echo
...
if [ "$OPTION" = "1" ]; then
    ...
    for file in "${files[@]}"; do
        ...
        echo "Quando a Instalacao terminar, pressione ENTER para continuar..."
        read

        log "Concluido $(basename "$file")"
